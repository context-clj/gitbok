(ns markdown.core
  (:require [clojure.java.io :as io]
            [markdown.common :refer [*inhibit-separator*]]
            [markdown.links :refer [parse-references parse-footnotes]]
            [markdown.transformers :refer [transformer-vector footer parse-metadata-headers]])
